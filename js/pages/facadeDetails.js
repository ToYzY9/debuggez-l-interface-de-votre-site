...
const fillWeatherForecastTable = (weatherForecastData) => {
    ...
    img.setAttribute("src", `${weatherForecastData.current.weather_icons}`);
    $weatherIcon.appendChild(img);
    console.log("🚀 ~ fillWeatherForecastTable ~ $weatherIcon:", $weatherIcon);

    $weatherDescription.textContent =
        weatherForecastData.current.weather_descriptions;
    $weatherWind.textContent = weatherForecastData.current.wind_speed;
    ...
    $weatherIsDay.textContent = weatherForecastData.current.is_day;
};
